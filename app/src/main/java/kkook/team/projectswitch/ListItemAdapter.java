...
public class ListItemAdapter extends BaseAdapter implements OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_01:
                //add frined
                if(clickItem.getDataType() == 0) {
                    clickItem.setDataType(1);
                    view.setBackground(view.getResources().getDrawable(R.drawable.oval_frame_yellow));
                    nSelectedItemNum++;
                }
                break;
            case R.id.btn_02:
                //delete friend
                if(clickItem.getDataType() == 1) {
                    clickItem.setDataType(0);
                    view.setBackground(view.getResources().getDrawable(R.drawable.oval_frame));
                    nSelectedItemNum--;
                }
                break;
        }
